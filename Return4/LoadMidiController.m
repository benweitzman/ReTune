...
@implementation LoadMidiController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //NSLog(@"%d",index);
    cell.textLabel.text = [midiFiles objectAtIndex:indexPath.row];
    //NSLog(@"%d",);
    // Configure the cell...
...
{
    //NSUInteger index = [indexPath indexAtPosition:0];
    //NSLog(@"%@",[midiFiles objectAtIndex:index]);
    [delegate LoadMidiController:self didFinishWithSelection:[midiFiles objectAtIndex:indexPath.row]];
